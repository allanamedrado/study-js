...
//DOM - modificar a web, pegar eventos do usuario
let msg = 'oi'

function altararMessage(message) {
    document.getElementById('percent').textContent = message
}

altararMessage(msg)

//tbm podemos alterar estilo
...
click.addEventListener('click', function () {
    ...
    if(review.classList.contains('d-none')) {
        ...
        click.textContent = 'CLOSE REVIEW'
    } else {
        review.classList.add('d-none')
        click.textContent = 'SEE REVIEW'

    }
})

//mostrar e esconder elementos na DOM
